...
static int R_Branch_Profiling = 0;	      	   /* whether to record only the trailing branch of call trees */
...
static void R_InitProfiling(SEXP filename, int append, double dinterval,
			    ...
			    int line_profiling, int branch_profiling,
			    int numfiles, int bufsize)
{
    ...
    R_Branch_Profiling = branch_profiling;
...
{
    SEXP filename;
    int append_mode, mem_profiling, gc_profiling, line_profiling, branch_profiling;
    double dinterval;
	...
	R_InitProfiling(filename, append_mode, dinterval, mem_profiling,
			gc_profiling, line_profiling, branch_profiling,
			numfiles, bufsize);
    else
	R_EndProfiling();
    return R_NilValue;
